...
//        String secondFile = sc.nextLine();
        ...
        String firstFile = "src/_02/_10/file1.txt";
        String secondFile = "src/_02/_10/file2.txt";

        try {
            BufferedReader file1 = new BufferedReader(new InputStreamReader(new FileInputStream(firstFile)));
        ...
        try {
            BufferedReader file2 = new BufferedReader(new InputStreamReader(new FileInputStream(secondFile)));
    ...
    public void joinData() throws CorruptedDataException {
        if (allLines.containsAll(forRemoveLines)) {
            ...
            allLines.clear();
            throw new CorruptedDataException("The list is clear!");
        }
    }
}
