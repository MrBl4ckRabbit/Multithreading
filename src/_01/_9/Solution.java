...
Если скорость бегуна 2 шага в секунду, метод должен работать пол секунды; если скорость бегуна 4 шага в секунду,
...
public class Solution {
    ...
    public static class Stopwatch extends Thread {
        ...
        private void doStep() throws InterruptedException {
            stepNumber++;
            Thread.sleep(((1000 / owner.getSpeed())));//делим количество секунд на количество шагов по условию
            //sleep тут нужен чтобы скорость реальная считалась
